...
const AdminDeleteSalesStaffService = {
    AdminDeleteSalesStaff(id) {
        return axiosClient.delete('/account/admin-sale-staff/' + id + '/', id)
            .then(response => {
...
export default AdminDeleteSalesStaffService;
