...
const AdminDeletePurchaseStaffService = {
    AdminDeletePurchaseStaff(id) {
        return axiosClient.delete('/account/admin-purchase-staff/' + id + '/', id)
            .then(response => {
...
export default AdminDeletePurchaseStaffService;
