...
const AdminItemCategoryAddService = {
    AdminItemCategoryAdd(data) {
        return axiosClient.post("/admin-item-categories/", data)
            .then(response => {
...
export default AdminItemCategoryAddService;
