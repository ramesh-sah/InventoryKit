...
const AdminUpdatePurchaseStaffService = {
    AdminUpdatePurchaseStaff(data, id) {
        return axiosClient.patch("account/admin-purchase-staff/" + id + "/", data)
            .then(response => {
...
export default AdminUpdatePurchaseStaffService;
