...
const AdminExpenseCategoryAddService = {
    AdminExpenseCategoryAdd(data) {
        return axiosClient.post("/admin-expense-categories/", data)
            .then(response => {
...
export default AdminExpenseCategoryAddService;
