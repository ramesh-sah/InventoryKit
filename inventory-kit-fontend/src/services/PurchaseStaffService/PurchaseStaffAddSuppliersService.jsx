...
const PurchaseStaffAddSuppliersService = {
    PurchaseStaffSuppliersAdd(data) {
        return axiosClient.post("/purchase-staff-suppliers/", data)
            .then(response => {
...
export default PurchaseStaffAddSuppliersService;
