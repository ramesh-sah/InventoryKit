...
// import AdminViewCustomersService from '../../../services/AdminServices/AdminViewCustomersService';
// import { Button, Menu, MenuItem, Snackbar, Dialog, DialogActions, DialogContent, DialogTitle, TextField } from '@mui/material';
...
//     setSnackbarMessage(`Updated customer: ${formData.lastName}`);
...
//       // Optionally, update the rows state to remove the deleted customer
...
//           variant="contained"
//           color="primary"
//           onClick={(e) => handleMenuClick(e, params.row)} // Pass the entire row to the menu handler
//         >
//           Actions
//         </Button>
//       ),
...
//       <Dialog open={openDialog} onClose={handleUpdateClose}>
