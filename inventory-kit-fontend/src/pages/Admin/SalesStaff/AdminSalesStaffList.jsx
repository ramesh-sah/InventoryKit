...
import AdminSalesStaffListService from './../../../services/AdminServices/AdminSalesStaffListService';
import AdminUpdateSalesStaffService from './../../../services/AdminServices/AdminUpdateSalesStaffService';
import AdminDeleteSalesStaffService from './../../../services/AdminServices/AdminDeleteSalesStaffService';
...
export default function AdminPurchaseStaffList() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const purchaseStaff = await AdminSalesStaffListService.fetchSalesStaff();
  ...
  const handleFormSubmit = async () => {
    ...
    await AdminUpdateSalesStaffService.AdminUpdateSalesStaff(formData, formData.id);
  ...
  const handleDelete = async () => {
    if (selectedPurchaseStaff) {
      ...
      await AdminDeleteSalesStaffService.AdminDeleteSalesStaff(selectedPurchaseStaff.id); // Call the service
