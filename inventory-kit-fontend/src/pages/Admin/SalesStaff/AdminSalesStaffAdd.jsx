...
import AdminSalesStaffAddService from './../../../services/AdminServices/AdminSalesStaffAddService';
...
const AdminSalesStaffAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await AdminSalesStaffAddService.AdminSalesStaffAdd(formData);
      alert('Sales staff added successfully!');
      navigate('/admin-sale-staff/sale-staff-list');
...
export default AdminSalesStaffAdd;