...
import PurchaseStaffAddSuppliersService from './../../../services/PurchaseStaffService/PurchaseStaffAddSuppliersService';
...
const PurchaseStaffSuppliersAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await PurchaseStaffAddSuppliersService.PurchaseStaffSuppliersAdd(formData); // Call the service
